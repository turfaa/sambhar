    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (Object obj3 : typeArr) {
                Utils.checkNotNull(obj3, "typeArgument == null");
                Utils.checkNotPrimitive(obj3);
            }
            this.ownerType = type;
            this.rawType = type2;
    ...
    static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type2 instanceof Class) {
            ...
            if (resolveTypeVariable.isArray()) {
                ...
                Class resolve = resolve(type, cls, componentType);
                if (componentType != resolve) {
                    resolveTypeVariable = new GenericArrayTypeImpl(resolve);
                }
                return resolveTypeVariable;
            }
        }
        ...
        if (type2 instanceof ParameterizedType) {
            ...
            Type resolve2 = resolve(type, cls, resolveTypeVariable);
            Object obj = resolve2 != resolveTypeVariable ? 1 : null;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            while (i < length) {
                Type resolve3 = resolve(type, cls, actualTypeArguments[i]);
            ...
            return obj != null ? new ParameterizedTypeImpl(resolve2, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
            ...
            if (lowerBounds.length == 1) {
                ...
                if (resolve(type, cls, upperBounds[0]) != upperBounds[0]) {
