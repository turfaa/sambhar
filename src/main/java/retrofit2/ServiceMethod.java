        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Url) {
                ...
                if (Iterable.class.isAssignableFrom(rawType2)) {
                    if (type instanceof ParameterizedType) {
                        return new QueryName(this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), encoded).iterable();
                    }
                    stringBuilder = new StringBuilder();
                    ...
                    return new QueryName(this.retrofit.stringConverter(type, annotationArr), encoded);
                } else {
                    return new QueryName(this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType2.getComponentType()), annotationArr), encoded).array();
                }
                ...
                if (Iterable.class.isAssignableFrom(rawType2)) {
                    ...
                    return new Header(value2, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType2.getComponentType()), annotationArr)).array();
                }
                ...
                if (Map.class.isAssignableFrom(rawType3)) {
                    ...
                    if (type instanceof ParameterizedType) {
                        ...
                        if (String.class == rawType3) {
                            return new HeaderMap(this.retrofit.stringConverter(Utils.getParameterUpperBound(1, parameterizedType), annotationArr));
                        }
                        stringBuilder = new StringBuilder();
                ...
                if (this.isFormEncoded) {
                    ...
                    if (Iterable.class.isAssignableFrom(rawType4)) {
                        if (type instanceof ParameterizedType) {
                            return new Field(value, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), encoded).iterable();
                        }
                        stringBuilder = new StringBuilder();
                        ...
                        return new Field(value, this.retrofit.stringConverter(type, annotationArr), encoded);
                    } else {
                        return new Field(value, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType4.getComponentType()), annotationArr), encoded).array();
                    }
                }
                        ...
                        if (Iterable.class.isAssignableFrom(rawType)) {
                            if (type instanceof ParameterizedType) {
                                ...
                                if (!MultipartBody.Part.class.isAssignableFrom(Utils.getRawType(type))) {
                                    return new Part(of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations)).iterable();
                                }
