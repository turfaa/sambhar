...
public class AudioAttributesCompat {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(this.mContentType == audioAttributesCompat.getContentType() && this.mFlags == audioAttributesCompat.getFlags() && this.mUsage == audioAttributesCompat.getUsage() && (!this.mLegacyStream == null ? !this.mLegacyStream.equals(audioAttributesCompat.mLegacyStream) : audioAttributesCompat.mLegacyStream != null))) {
            z = false;
        }
        return z;
    }
