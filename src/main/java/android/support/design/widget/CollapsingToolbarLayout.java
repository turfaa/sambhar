...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (super.drawChild(canvas, view, j) || obj != null) {
            return true;
        }
        return false;
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.collapsingTitleEnabled && this.dummyView != null) {
            Object obj = 1;
            z = ViewCompat.isAttachedToWindow(this.dummyView) && this.dummyView.getVisibility() == 0;
            this.drawCollapsingTitle = z;
            if (this.drawCollapsingTitle) {
                if (ViewCompat.getLayoutDirection(this) != 1) {
                    obj = null;
                }
                systemWindowInsetTop = getMaxOffsetForPinChild(this.toolbarDirectChild != null ? this.toolbarDirectChild : this.toolbar);
                DescendantOffsetUtils.getDescendantRect(this, this.dummyView, this.tmpRect);
                this.collapsingTextHelper.setCollapsedBounds(this.tmpRect.left + (obj != null ? this.toolbar.getTitleMarginEnd() : this.toolbar.getTitleMarginStart()), (this.tmpRect.top + systemWindowInsetTop) + this.toolbar.getTitleMarginTop(), this.tmpRect.right + (obj != null ? this.toolbar.getTitleMarginStart() : this.toolbar.getTitleMarginEnd()), (this.tmpRect.bottom + systemWindowInsetTop) - this.toolbar.getTitleMarginBottom());
        ...
        for (int i6 = 0; i6 < systemWindowInsetTop; i6++) {
