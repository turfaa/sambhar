...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback dragCallback = new Callback() {
        ...
        L_0x0009:
            r9 = android.support.design.widget.BottomSheetBehavior.this;
            r9 = r9.fitToContents;
            if (r9 == 0) goto L_0x0018;
        L_0x0011:
            r9 = android.support.design.widget.BottomSheetBehavior.this;
            r9 = r9.fitToContentsOffset;
        L_0x0015:
            r2 = 3;
            goto L_0x00d4;
        L_0x0018:
            r9 = r8.getTop();
            r10 = android.support.design.widget.BottomSheetBehavior.this;
            r10 = r10.halfExpandedOffset;
            if (r9 <= r10) goto L_0x002a;
        L_0x0022:
            r9 = android.support.design.widget.BottomSheetBehavior.this;
            r0 = r9.halfExpandedOffset;
        L_0x0026:
            r9 = r0;
            r2 = 6;
            goto L_0x00d4;
        ...
        L_0x0068:
            r9 = android.support.design.widget.BottomSheetBehavior.this;
            r9 = r9.collapsedOffset;
            goto L_0x00d4;
        L_0x006d:
            r9 = r8.getTop();
            r10 = android.support.design.widget.BottomSheetBehavior.this;
            r10 = r10.fitToContents;
            if (r10 == 0) goto L_0x009a;
        L_0x0079:
            r10 = android.support.design.widget.BottomSheetBehavior.this;
            r10 = r10.fitToContentsOffset;
            r10 = r9 - r10;
            r10 = java.lang.Math.abs(r10);
            r0 = android.support.design.widget.BottomSheetBehavior.this;
            r0 = r0.collapsedOffset;
            r9 = r9 - r0;
            r9 = java.lang.Math.abs(r9);
            if (r10 >= r9) goto L_0x0094;
        L_0x008e:
            r9 = android.support.design.widget.BottomSheetBehavior.this;
            r0 = r9.fitToContentsOffset;
            r9 = r0;
            goto L_0x0015;
        L_0x0094:
            r9 = android.support.design.widget.BottomSheetBehavior.this;
            r0 = r9.collapsedOffset;
        L_0x0098:
            r9 = r0;
            goto L_0x00d4;
        L_0x009a:
        ...
        L_0x00e2:
            ...
            r9 = new android.support.design.widget.BottomSheetBehavior$SettleRunnable;
            r10 = android.support.design.widget.BottomSheetBehavior.this;
            r9.<init>(r8, r2);
            android.support.v4.view.ViewCompat.postOnAnimation(r8, r9);
            goto L_0x00f8;
        L_0x00f3:
            r8 = android.support.design.widget.BottomSheetBehavior.this;
            ...
            if (actionMasked != 3) {
                switch (actionMasked) {
                    case 0:
                        ...
                        boolean z2 = this.activePointerId == -1 && !coordinatorLayout.isPointInChildBounds(v, x, this.initialY);
    ...
    public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull View view, int i, int i2, @NonNull int[] iArr, int i3) {
        if (i3 != 1 && view == ((View) this.nestedScrollingChildRef.get())) {
            ...
            if (i2 > 0) {
                ...
                if (i3 <= this.collapsedOffset || this.hideable) {
                    iArr[1] = i2;
                    ViewCompat.offsetTopAndBottom(v, -i2);
                    setStateInternal(1);
                } else {
    ...
    public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull View view, int i) {
        ...
        if (v.getTop() == getExpandedOffset()) {
            ...
            if (this.lastNestedScrollDy > 0) {
                ...
                if (this.lastNestedScrollDy == 0) {
                    expandedOffset = v.getTop();
                    if (!this.fitToContents) {
                        if (expandedOffset < this.halfExpandedOffset) {
                            if (expandedOffset < Math.abs(expandedOffset - this.collapsedOffset)) {
                                expandedOffset = 0;
                            } else {
                                expandedOffset = this.halfExpandedOffset;
                            }
                        } else if (Math.abs(expandedOffset - this.halfExpandedOffset) < Math.abs(expandedOffset - this.collapsedOffset)) {
                            expandedOffset = this.halfExpandedOffset;
                        } else {
                            expandedOffset = this.collapsedOffset;
                        }
                        i2 = 6;
                    } else if (Math.abs(expandedOffset - this.fitToContentsOffset) < Math.abs(expandedOffset - this.collapsedOffset)) {
    ...
    L_0x0005:
        r4 = r3.peekHeightAuto;
        if (r4 != 0) goto L_0x0015;
    L_0x0009:
        r3.peekHeightAuto = r0;
        goto L_0x0024;
    L_0x000c:
        r2 = r3.peekHeightAuto;
