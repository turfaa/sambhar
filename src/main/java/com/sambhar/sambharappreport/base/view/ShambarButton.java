...
public class ShambarButton extends AppCompatButton {
    String customFont;

    public ShambarButton(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        style(context, attributeSet);
    }

    public ShambarButton(Context context, AttributeSet attributeSet, int i) {
