...
public class ShambarEditText extends AppCompatEditText {
    String customFont;

    public ShambarEditText(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        style(context, attributeSet);
    }

    public ShambarEditText(Context context, AttributeSet attributeSet, int i) {
