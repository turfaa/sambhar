...
public class TwitterCore {
    ...
    TwitterCore(TwitterAuthConfig twitterAuthConfig, ConcurrentHashMap<Session, TwitterApiClient> concurrentHashMap, TwitterApiClient twitterApiClient) {
        ...
        this.twitterSessionManager = new PersistedSessionManager(new PreferenceStoreImpl(this.context, SESSION_PREF_FILE_NAME), new Serializer(), PREF_KEY_ACTIVE_TWITTER_SESSION, PREF_KEY_TWITTER_SESSION);
        this.guestSessionManager = new PersistedSessionManager(new PreferenceStoreImpl(this.context, SESSION_PREF_FILE_NAME), new Serializer(), PREF_KEY_ACTIVE_GUEST_SESSION, PREF_KEY_GUEST_SESSION);
