...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    public void _reportMismatchedEndMarker(int i, char c) throws JsonParseException {
        ...
        stringBuilder3.append(this._parsingContext.typeDesc());
    ...
    public void _parseNumericValue(int i) throws IOException {
        if (this._currToken == JsonToken.VALUE_NUMBER_INT) {
            ...
            if (i2 <= 9) {
                i = NumberInput.parseInt(textBuffer, textOffset, i2);
                if (this._numberNegative) {
                    i = -i;
                }
                this._numberInt = i;
    ...
    public void reportOverflowInt() throws IOException {
        _reportError(String.format("Numeric value (%s) out of range of int (%d - %s)", new Object[]{getText(), Integer.valueOf(Integer.MIN_VALUE), Integer.valueOf(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED)}));
    }
    ...
    public IllegalArgumentException reportInvalidBase64Char(Base64Variant base64Variant, int i, int i2, String str) throws IllegalArgumentException {
        ...
        if (i <= 32) {
            ...
            stringBuilder3.append(i2 + 1);
            stringBuilder3.append(" of 4-char base64 unit: can only used between units");
            stringBuilder = stringBuilder3.toString();
        } else if (base64Variant.usesPaddingChar(i)) {
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Unexpected padding character ('");
            stringBuilder2.append(base64Variant.getPaddingChar());
            ...
            stringBuilder3 = new StringBuilder();
            stringBuilder3.append("Illegal character (code 0x");
            stringBuilder3.append(Integer.toHexString(i));
            stringBuilder3.append(") in base64 content");
            stringBuilder = stringBuilder3.toString();
        } else {
            stringBuilder3 = new StringBuilder();
            stringBuilder3.append("Illegal character '");
            stringBuilder3.append((char) i);
            stringBuilder3.append("' (code 0x");
            stringBuilder3.append(Integer.toHexString(i));
            stringBuilder3.append(") in base64 content");
            stringBuilder = stringBuilder3.toString();
        }
        ...
        return new IllegalArgumentException(stringBuilder);
    }
