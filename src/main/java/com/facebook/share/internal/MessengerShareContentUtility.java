...
public class MessengerShareContentUtility {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$facebook$share$model$ShareMessengerGenericTemplateContent$ImageAspectRatio = new int[ImageAspectRatio.values().length];
        static final /* synthetic */ int[] $SwitchMap$com$facebook$share$model$ShareMessengerMediaTemplateContent$MediaType = new int[MediaType.values().length];
        ...
        static {
            ...
            r0 = 1;
            r1 = $SwitchMap$com$facebook$share$model$ShareMessengerMediaTemplateContent$MediaType;	 Catch:{ NoSuchFieldError -> 0x0014 }
        ...
        L_0x0014:
            ...
            r1 = $SwitchMap$com$facebook$share$model$ShareMessengerGenericTemplateContent$ImageAspectRatio;	 Catch:{ NoSuchFieldError -> 0x0027 }
        ...
        L_0x0027:
            ...
            r1 = $SwitchMap$com$facebook$share$model$ShareMessengerURLActionButton$WebviewHeightRatio;	 Catch:{ NoSuchFieldError -> 0x003a }
        ...
        L_0x003a:
            r0 = $SwitchMap$com$facebook$share$model$ShareMessengerURLActionButton$WebviewHeightRatio;	 Catch:{ NoSuchFieldError -> 0x0045 }
    ...
    private static void addURLActionButton(Bundle bundle, ShareMessengerURLActionButton shareMessengerURLActionButton, boolean z) throws JSONException {
        ...
        if (z) {
            ...
            stringBuilder.append(shareMessengerURLActionButton.getTitle());
            stringBuilder.append(" - ");
            stringBuilder.append(Utility.getUriString(shareMessengerURLActionButton.getUrl()));
            uriString = stringBuilder.toString();
        }
    ...
    private static String getShouldHideShareButton(ShareMessengerURLActionButton shareMessengerURLActionButton) {
        return shareMessengerURLActionButton.getShouldHideWebviewShareButton() ? SHARE_BUTTON_HIDE : null;
    }
}
