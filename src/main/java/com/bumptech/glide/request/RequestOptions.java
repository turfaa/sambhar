...
public class RequestOptions implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public RequestOptions theme(@Nullable Theme theme) {
        if (this.isAutoCloneEnabled) {
    ...
    private RequestOptions scaleOnlyTransform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation, boolean z) {
        RequestOptions transform = z ? transform(downsampleStrategy, (Transformation) transformation) : optionalTransform(downsampleStrategy, (Transformation) transformation);
