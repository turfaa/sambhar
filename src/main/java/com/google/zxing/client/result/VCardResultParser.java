...
public final class VCardResultParser extends ResultParser {
    ...
    static List<List<String>> matchVCardPrefixedField(CharSequence charSequence, String str, boolean z, boolean z2) {
        ...
        while (i2 < length) {
            ...
            if (group != null) {
                ...
                str3 = null;
                while (i4 < length2) {
                    Object obj2 = split[i4];
                    if (list2 == null) {
                        list2 = new ArrayList(1);
                    }
                    list2.add(obj2);
                    String[] split2 = EQUALS.split(obj2, i3);
                    if (split2.length > 1) {
    ...
    private static void maybeAppendFragment(ByteArrayOutputStream byteArrayOutputStream, String str, StringBuilder stringBuilder) {
        if (byteArrayOutputStream.size() > 0) {
            ...
            if (str == null) {
                str = new String(toByteArray, Charset.forName(Key.STRING_CHARSET_NAME));
            } else {
                try {
