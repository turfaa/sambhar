...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        r0[12] = new Version(13, 44, 44, 20, 20, new ECBlocks(56, new ECB(1, Errors.ALREADY_UNFAVORITED), null));
        ...
        r0[18] = new Version(19, 88, 88, 20, 20, new ECBlocks(56, new ECB(4, Errors.ALREADY_UNFAVORITED), null));
        ...
        r0[21] = new Version(22, 120, 120, 18, 18, new ECBlocks(68, new ECB(6, 175), null));
        r0[22] = new Version(23, 132, 132, 20, 20, new ECBlocks(62, new ECB(8, 163), null));
        r0[23] = new Version(24, Errors.ALREADY_UNFAVORITED, Errors.ALREADY_UNFAVORITED, 22, 22, new ECBlocks(62, new ECB(8, 156), new ECB(2, 155)));
