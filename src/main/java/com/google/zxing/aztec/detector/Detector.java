...
public final class Detector {
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) throws NotFoundException {
        ...
        f += (float) this.nbCenterLayers;
        return instance.sampleGrid(bitMatrix2, dimension, dimension, f2, f2, f, f2, f, f, f2, f, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }
