...
public class OkHttpClient implements Cloneable, Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder connectTimeout(long j, TimeUnit timeUnit) {
            this.connectTimeout = Util.checkDuration(DefaultSentryClientFactory.TIMEOUT_OPTION, j, timeUnit);
            return this;
        }

        public Builder readTimeout(long j, TimeUnit timeUnit) {
            this.readTimeout = Util.checkDuration(DefaultSentryClientFactory.TIMEOUT_OPTION, j, timeUnit);
            return this;
        }

        public Builder writeTimeout(long j, TimeUnit timeUnit) {
            this.writeTimeout = Util.checkDuration(DefaultSentryClientFactory.TIMEOUT_OPTION, j, timeUnit);
            return this;
        }
