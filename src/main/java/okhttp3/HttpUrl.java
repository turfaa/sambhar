    ...
    public static final class Builder {
        ...
        public ParseResult parse(@Nullable HttpUrl httpUrl, String str) {
                        ...
                        switch (charAt) {
                            ...
                            case '@':
                                if (obj == null) {
                                    ...
                                    if (i2 != i) {
                                        this.encodedPassword = HttpUrl.canonicalize(str, i2 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                        obj = 1;
                                    }
                                    obj2 = 1;
                                } else {
            ...
            if (portColonOffset < skipTrailingAsciiWhitespace && str2.charAt(portColonOffset) == '?') {
                int delimiterOffset2 = Util.delimiterOffset(str2, portColonOffset, skipTrailingAsciiWhitespace, '#');
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, portColonOffset + 1, delimiterOffset2, HttpUrl.QUERY_ENCODE_SET, true, false, true, true, null));
                portColonOffset = delimiterOffset2;
            }
            if (portColonOffset < skipTrailingAsciiWhitespace && str2.charAt(portColonOffset) == '#') {
